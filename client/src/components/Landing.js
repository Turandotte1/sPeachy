...
const Landing = () => {
  return (
    <div id="Landing">
      <h1>Simplify the communication</h1>
      <h3>
        We'are here to help you to collect an easy and constructive
        feedback from your users!
        No monthly payments.
        Simply buy the amount of surveys you need, precise your content
        and we'll take care of everything else.
      </h3>
      <div className="signup">
        <h4>sign up and interact with your users freely</h4>
        <div className="form">
          <input type="email" placeholder="Email"></input>
          <input type="password" placeholder="Password"></input>
        </div>
        <li className="button account-button">
            <a href="/auth/google">Create Account </a>
        </li>
        <li className="button google-button">
